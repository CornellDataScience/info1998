...
(HINT: the A4 assignment will probably be very helpful in answering this question)
...
Problem 2 (1 point): Why do these plots look the same? How do the axes compare? Why do we expect this?

...
preds_train = # FILL IN HERE
train_res = # FILL IN HERE
accuracy_Train = # FILL IN HERE

preds_test = # FILL IN HERE
test_res = # FILL IN HERE
...
logistic_regression = # FILL IN HERE

# TODO: fit the model using the train data
preds_train = # FILL IN HERE
predicted_classes = # FILL IN HERE
mean(predicted_classes == train_df$income)

preds_test = # FILL IN HERE
predicted_classes_test = # FILL IN HERE
...
```{r}
accuracies = c()
best_depth = 0      # Keep track of depth that produces tree with highest accuracy

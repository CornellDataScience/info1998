...
# Problem 2 (1 point): Determine the mean age of all these people and store them in a variable called 'mean_age_male_survivors'.
...
# Problem 3 (3 points): Impute the values that are NaN for the Fare column with the mean
```{r}
#fill in here
```
...
# Problem 4 (4 points): There are several rows with nan values for the age.
